...
--
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('Kuro', '123', N'Phạm Tân Tị', N'Quản Trị Viên', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('MeanSun', '123', N'Trần Minh Sơn', N'Quản Trị Viên', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('KHE', '76P31D', N'Lê Gia Hân', N'Khách Hàng', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('XLF', 'IVNELE', N'Đặng Anh Minh', N'Đối Tác', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('BAD', '0HXG93E', N'Đỗ Đức Tài', N'Tài Xế', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('WGK', '4O2L7C', N'Đặng Khánh Ngọc', N'Nhân Viên', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('KUM', 'U8HY78J3', N'Dương Trường An', N'Đối Tác', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('XKS', '5U85EGQ', N'Dương Anh Tuấn', N'Đối Tác', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('ZCQ', 'IIUHA9', N'Phan Bảo Vy', N'Nhân Viên', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('XAH', '3Q919SUL', N'Đặng Anh Dũng', N'Nhân Viên', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('WEC', '0RW566R', N'Lê Thanh Tùng', N'Nhân Viên', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('PEN', '88NUX3MJ', N'Hoàng Quang Mạnh', N'Khách Hàng', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('SXL', 'X6K3XUU7', N'Vũ Hoài An', N'Nhân Viên', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('ELR', 'M4TE4J8', N'Phạm Hải Đăng', N'Đối Tác', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('FKQ', '4H60L0', N'Vũ Bích Hà', N'Tài Xế', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('MUD', '9Z623JZ', N'Võ Chiến Thắng', N'Nhân Viên', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('EUR', 'M5O6277', N'Vũ Hùng Cường', N'Nhân Viên', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('NJF', 'J7102D26', N'Lý Thành Công', N'Khách Hàng', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('HNB', 'M4O9716', N'Huỳnh Khả Hân', N'Tài Xế', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('YRF', '8ZZS6G1', N'Huỳnh Bảo Vy', N'Nhân Viên', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('PGZ', 'C5K67YH9', N'Phạm Trường An', N'Tài Xế', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('KLX', 'SHZX6EK', N'Lý Cẩm Anh', N'Khách Hàng', 'Enabled')
GO
