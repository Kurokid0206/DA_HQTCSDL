...
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('LNTS', '1111', N'Lê Nam Thái Sơn', N'Quản Trị Viên', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('KHE', '76P31D', N'Lê Gia Hân', N'Tài Xế', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('XLF', 'IVNELE', N'Đặng Anh Minh', N'Khách Hàng', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('BAD', '0HXG93E', N'Đỗ Đức Tài', N'Nhân Viên', 'Disabled')
...
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('ZCQ', 'IIUHA9', N'Phan Bảo Vy', N'Khách Hàng', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('XAH', '3Q919SUL', N'Đặng Anh Dũng', N'Đối Tác', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('WEC', '0RW566R', N'Lê Thanh Tùng', N'Đối Tác', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('PEN', '88NUX3MJ', N'Hoàng Quang Mạnh', N'Đối Tác', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('SXL', 'X6K3XUU7', N'Vũ Hoài An', N'Tài Xế', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('ELR', 'M4TE4J8', N'Phạm Hải Đăng', N'Nhân Viên', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('FKQ', '4H60L0', N'Vũ Bích Hà', N'Tài Xế', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('MUD', '9Z623JZ', N'Võ Chiến Thắng', N'Khách Hàng', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('EUR', 'M5O6277', N'Vũ Hùng Cường', N'Tài Xế', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('NJF', 'J7102D26', N'Lý Thành Công', N'Khách Hàng', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('HNB', 'M4O9716', N'Huỳnh Khả Hân', N'Nhân Viên', 'Enabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('YRF', '8ZZS6G1', N'Huỳnh Bảo Vy', N'Khách Hàng', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('PGZ', 'C5K67YH9', N'Phạm Trường An', N'Tài Xế', 'Disabled')
INSERT dbo.TaiKhoan(TaiKhoan, MatKhau, NguoiDung, VaiTro, TrangThai) VALUES ('KLX', 'SHZX6EK', N'Lý Cẩm Anh', N'Nhân Viên', 'Enabled')
GO
